...
const Products = () => {
  ...
  useEffect(() => {
    fetch("https://nameless-headland-75190.herokuapp.com/products")
      .then((res) => res.json())
      .then((data) => {
    ...
    return (
      ...
      <h1 className="text-center mt-5 text-title">Ladies Bag</h1>
      <h6 className="text-center title-header mb-5">Your Desirable Bags Are Here</h6>
