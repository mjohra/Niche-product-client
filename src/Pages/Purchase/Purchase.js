...
const Purchase = () => {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post("https://nameless-headland-75190.herokuapp.com/addOrder", order)
  ...
  useEffect(() => {
    axios.get(`https://nameless-headland-75190.herokuapp.com/products/${id}`).then(function (response) {
