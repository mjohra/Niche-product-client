...
const ManageOrder = () => {
  ...
  useEffect(() => {
    fetch("https://nameless-headland-75190.herokuapp.com/allbooking")
      .then((res) => res.json())
  ...
  const handleDelete = (id) => {
    ...
    if (confirmation) {
      const url = `https://nameless-headland-75190.herokuapp.com/booking/${id}`;
      fetch(url, {
        method: "DELETE",
      })
        .then((res) => res.json())
  ...
  const handleUpdate = (id) => {
    axios
      .put(`https://nameless-headland-75190.herokuapp.com/booking/${id}`, { id })
